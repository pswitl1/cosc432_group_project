...
def main():
    ...
    parser.add_argument('--hidden-neurons', help='number of hidden neurons in training', type=int, default=25)
    parser.add_argument('--alpha', help='alpha in training', type=float, default=.0025)
    parser.add_argument('--epoch', help='number of epochs in training', type=int, default=750)
